...
import 'package:alpine/model/Semester.dart';


class sem_syllabus_screen extends StatefulWidget {

  final String department;
  sem_syllabus_screen(this.department , {Key key}) : super(key : key);

  @override
  _sem_syllabus_screenState createState() => _sem_syllabus_screenState();
}

class _sem_syllabus_screenState extends State<sem_syllabus_screen> {
        ...
        ListTile(
          ...
          onTap: () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => downloadSyllabusPage(Dept , semesterr)));
          },
        );
